...
export default {
    ...
    TILE({ data }: any, div: HTMLDivElement) {
        const { id, tier, copies, name, iconKey, icon, text, copyId } = data;
        div.style.backgroundColor = '#fbfbf8';
        div.style.color = 'black';
        div.style.display = 'flex';
        div.style.flexDirection = 'column';
        ...
        div.innerHTML = [
            (iconKey == null ? '' : `<img src="assets/game-icons/ffffff/transparent/1x1/${iconKey}.png" style="background-color: #ddd;">`),
